	...
	factory: (require) => {
		...
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=\"" + CSS_ID + "\"]") === null) {
			...
			tag.textContent = [
				...
				".ocg-timeremain{height:100%;flex:1 1 auto;min-width:0;background:var(--dsw-alias-brand-primary);border-radius:3px;transition:width .4s ease}",
						...
						children: [
							...
							(data && data.update && data.update.available && data.update.latest
								? react_jsx_runtime.jsx("a", {
									...
									href: "https://www.npmjs.com/package/@asterdolans/dsh-opencode-go-usage",
									target: "_blank",
									rel: "noreferrer",

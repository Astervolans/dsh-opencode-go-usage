 ...
 *   - Install: `dsh plugin --profile web add @asterdolans/dsh-opencode-go-usage` — the
...
const NPM_PACKAGE = "@asterdolans/dsh-opencode-go-usage";
...
export function apply(ctx, rawConfig = {}) {
	...
	// (`dsh plugin --profile web add @asterdolans/dsh-opencode-go-usage@latest`).
